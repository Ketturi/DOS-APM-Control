;shutdown via APMv1.0 interface.
...
_start:  
        ...
        ;turn off the system, might not work on old APM versions, or AT power supplies.
        mov     ax, 5307h
        mov     bx, 0001h
        mov     cx, 0003h
        int     15h
        ...
        ; If successful, halt cpu. System should be turned of now.
        hlt
